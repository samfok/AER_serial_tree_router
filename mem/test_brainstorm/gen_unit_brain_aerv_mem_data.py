...
np.savetxt('unit_bs_aerv_mem.in', mem_in, '%d')
np.savetxt('unit_bs_aerv_mem_row_select.out', mem_row_select_out, '%d')
np.savetxt('unit_bs_aerv_mem_col_select.out', mem_col_select_out, '%d')
np.savetxt('unit_bs_aerv_mem_write.out', mem_write_out, '%d')
