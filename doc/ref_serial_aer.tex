...
\subsubsection*{Alternative 1: HSE}

directly translating CHP

\begin{hse}
*[[pi->po+;
    [p0->c0o+;c0+,c1-,[c0i];u0+;po-;[~p0];v+;po+
    []p1->c1o+;c1+,c0-,[c1i];u1+;po-;[~p1];v+;po+
    ]
  []p0&c0->c00+;[~c0i];po-;[~p0];c00-;[c0i];po+
  []p1&c0->c01+;[~c0i];po-;[~p1];c01-;[c0i];po+
  []p0&c1->c10+;[~c1i];po-;[~p0];c10-;[c1i];po+
  []p1&c1->c11+;[~c1i];po-;[~p1];c11-;[c1i];po+
  []~pi&c0->c0o-;[~c0i];u0-;v-;po-
  []~pi&c1->c1o-;[~c1i];u1-;v-;po-
 ]]
\end{hse}
...
\begin{hse}
*[[pi->po+;
    [p0->c0o+;cco+,([c0i];cci+);u+;po-;[~p0];v+;po+
    []p1->c1o+;cco+,([c1i];cci+);u+;po-;[~p1];v+;po+
    ]
  []p0&c0o->c00+;[~c0i];cci-;po-;[~p0];c00-;[c0i];cci+;po+
  []p1&c0o->c01+;[~c0i];cci-;po-;[~p1];c01-;[c0i];cci+;po+
  []p0&c1o->c10+;[~c1i];cci-;po-;[~p0];c10-;[c1i];cci+;po+
  []p1&c1o->c11+;[~c1i];cci-;po-;[~p1];c11-;[c1i];cci+;po+
  []~pi->c0o-,c1o-;cco-,([~c0i&~c1i];cci-);(u-;v-),po-
 ]]
\end{hse}

As we'll see in the PRS, $v\downarrow$ is only acknowledged by 
$c[0,1]_o\uparrow$.

\subsubsection*{Alternative 1: PRS}
...
This alternative is more expensive than the primary design because
of its bigger data gates. The primary design avoids the high cost by
acknowledging the parent data before signaling the the children.
