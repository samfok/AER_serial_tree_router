...
\subsubsection*{Alternative 0: HSE}
...
\begin{center}
    ...
    $c[0,1]s$ & 8 & \\ \hline
    $c[0,1][0,1]$ & 16 & \\ \hline
    \hline total & 69 & 67 if $cc_i$ flattened in $p_o$ \\ \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    rule & transistor count & comments \\ \hline
    $uu$ & 8 & \\ \hline
    $cc_i$ & 8 & could flatten in $p_o$ \\ \hline
    $p_o$ & 8 & \\ \hline
    $u[0,1,2,3]$ & 28 & \\ \hline
    $v$ & 14 & \\ \hline
    $c[0,1,2,3]s$ & 16 & \\ \hline
    $c[0,1,2,3][0,1,2,3]$ & 64 & \\ \hline
    \hline total & 146 & 144 if $cc_i$ flattened in $p_o$ \\ \hline
    \end{tabular}
\end{center}
