...
*[[si];
  ...
  ..
  [xm0->y0+;[ya];um+;y0-;[~ya];sm(m\+1)+;
  []xm1->y1+;[ya];um+;y1-;[~ya];sm(m\+1)+;
  ];
  ..
  [x(M\-1)0->y0+;[ya];u(M\-1)+;y0-;[~ya];so+;
  []x(M\-1)1->y1+;[ya];u(M\-1)+;y1-;[~ya];so+;
  ];
  [~si];
  u0-;[~x00&~x01];s01-;
  ..
...
\begin{prs2}
x(M\-1)0 & ~u(M\-1) & s(M\-1) -> y0+
u(M\-1) & ~sM -> y0-

x(M\-1)1 & ~u(M\-1) & s(M\-1) -> y1+
u(M\-1) & ~sM -> y1-
\end{prs2}
...
\begin{prs2}
x(M\-1)0 & _u(M\-1) & s(M\-1) -> _y0-
~_u(M\-1) & ~sM -> _y0+

x(M\-1)1 & _u(M\-1) & s(M\-1) -> _y1-
~_u(M\-1) & ~sM -> _y1+
\end{prs2}
