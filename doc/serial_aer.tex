...
Repeat {
    ...
    Relay $\emptyset$ from selected neuron to the parent.
}
\end{lstlisting}
...
\begin{hse}
*[[c0i->po+;[pi];p0+;[~pi];p0-;[pi];\textcolor{red}{c0o+};[~c0i];po-;[~pi];c0o-
  \|c1i->po+;[pi];p1+;[~pi];p1-;[pi];\textcolor{red}{c1o+};[~c1i];po-;[~pi];c1o-
 ]]
\end{hse}

\noindent
We introduce state variables $c0$ and $c1$ to represent the arbitration

\begin{hse}
*[[c0i->\textcolor{red}{c0+};po+;[pi];p0+;[~pi];p0-;[pi];c0o+;[~c0i];\textcolor{red}{c0-};po-;[~pi];c0o-
  \|c1i->\textcolor{red}{c1+};po+;[pi];p1+;[~pi];p1-;[pi];c1o+;[~c1i];\textcolor{red}{c1-};po-;[~pi];c1o-
 ]]
\end{hse}
...
\begin{hse}
*[[c0i->\textcolor{red}{c0+};[~c0i];\textcolor{red}{c0-}
  \|c1i->\textcolor{red}{c1+};[~c1i];\textcolor{red}{c1-}
 ]]
\end{hse}

\begin{hse}
*[[\textcolor{red}{c0}->po+;[pi];p0+;[~pi];p0-;[pi];c0o+;[\textcolor{red}{~c0}];po-;[~pi];c0o-
  []\textcolor{red}{c1}->po+;[pi];p1+;[~pi];p1-;[pi];c1o+;[\textcolor{red}{~c1}];po-;[~pi];c1o-
 ]]
\end{hse}

\noindent
Finally, we introduce state variable $u$ to distinguish between indistinguishable
...
*[[c0->po+;[pi];p0+;[~pi];\textcolor{red}{u+};p0-;[pi];c0o+;[~c0];po-;[~pi];c0o-;\textcolor{red}{u-}
  []c1->po+;[pi];p1+;[~pi];\textcolor{red}{u+};p1-;[pi];c1o+;[~c1];po-;[~pi];c1o-;\textcolor{red}{u-}
 ]]
\end{hse}
...
\begin{csp}
*[[#{C0=\neg\emptyset}->P!C0?;P!0;U!0
  \|#{C1=\neg\emptyset}->P!C1?;P!1;U!1
 ]]

*[[(#{C0=0}|#{C0=1})&#{U=0}->P!C0?
  [](#{C1=0}|#{C1=1})&#{U=1}->P!C1?
  []#{C0=\emptyset}&#{U=0}->P!C0?;U
  []#{C1=\emptyset}&#{U=1}->P!C1?;U
 ]]
\end{csp}
...
*[[c00|c10|w0->p0+;[~pi];c0o-;[~c00&~c10&~w0];p0-;[pi];c0o+
  []c01|c11|w1->p1+;[~pi];c1o-;[~c01&~c11&~w1];p1-;[pi];c1o+
 ]]
\end{hse}

\noindent 
To match the pseudo-code with the HSE, 
it's helpful to consider the projection of the HSE on to the parent's 
