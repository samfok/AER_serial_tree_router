...
\begin{easylist}
    ...
    &&& \textbf{SPLIT} (Section~\ref{sec:DESERIAL_CHAIN_HEAD})
    &&& \textbf{NODE} (Section~\ref{sec:DESERIAL_CHAIN_NODE})
    &&& \textbf{TAIL} (Section~\ref{sec:DESERIAL_CHAIN_TAIL})
    && split ring deserializer (Section~\ref{sec:DESERIAL_SPLITRING})
    &&& \textbf{SPLIT} (Section~\ref{sec:DESERIAL_SPLITRING_SPLIT})
    &&& \textbf{NODE} (Section~\ref{sec:DESERIAL_SPLITRING_NODE})
...
Although it has a bit more expensive 1-of-4 implementation than the split ring of Section~\ref{sec:DESERIAL_SPLITRING}, its signal fanouts remain constant 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Split Ring Deserializer \label{sec:DESERIAL_SPLITRING}}
...
\begin{center}
  \includegraphics[width=.45\textwidth]{img/deserial_achan_splitchain.pdf}
\end{center}
...
\begin{center}
    ...
    NODE (end) & 41 & 1 & 41 \\ \hline
    \hline \multicolumn{3}{|r|}{approx. transistors/deserializer} & $42M+4$ \\ \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    OUT a1ofN & 4 & 1 & 4 \\ \hline
    SPLIT & $3M-2$ & 1 & $3M-2$ \\ \hline
    NODE & 59 & $M-1$ & $59(M-1)$ \\ \hline
    NODE (end) & 61 & 1 & 61 \\ \hline
    \hline \multicolumn{3}{|r|}{approx. transistors/deserializer} & $62M+4$ \\ \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    NODE (end) & 41 & 1 & 41 \\ \hline
    \hline \multicolumn{3}{|r|}{total transistors/deserializer} & 504 \\ \hline
    \end{tabular}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{SPLIT \label{sec:DESERIAL_SPLITRING_SPLIT}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{NODE \label{sec:DESERIAL_SPLITRING_NODE}}

NODE latches data from SPLIT.

\begin{hse}
*[[ye&si];u-;
    [x0->y0+;xa+;[~x0];so+;u+;xa-;[~ye];y0-;[~si];so-
    []x1->y1+;xa+;[~x1];so+;u+;xa-;[~ye];y1-;[~si];so-
    ]
 ]
\end{hse}
...
The end NODE needs to have its $y[0,1]$ pulldown rules strengthened with $u$
to ensure that $s_o$ has gone high before $y[0,1]$ get pulled down. Otherwise
$s_o$ would be unstable.
...
\begin{center}
    ...
    \hline
    rule & transistor count & comments \\ \hline
    $y[0,1][0,1]$ & 14 & 16 for end NODE\\ \hline
    $u$ & 8 & \\ \hline
    $xa$ & 4 & \\ \hline
    $s_o$ & 9 & \\ \hline
    $vy$ & 4 & \\ \hline
    \hline total & 39 & 41 for end NODE \\ \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    \hline
    rule & transistor count & comments \\ \hline
    $y[0,1,2,3][0,1,2,3]$ & 28 & 32 for end NODE \\ \hline
    $u$ & 8 & \\ \hline
    $xa$ & 4 & \\ \hline
    $s_o$ & 11 & \\ \hline
    $vy$ & 8 & \\ \hline
    \hline total & 59 & 61 for end NODE \\ \hline
    \end{tabular}
\end{center}
...
\begin{center}
  \includegraphics[width=.45\textwidth]{img/deserial_echan_splitchain.pdf}
\end{center}
