...
\noindent
but this would have a costly overhead. Further, we would be required to
use the 1-of-2 instead of 1-of-4 deserializer. The 1-of-4
deserializer cuts the number of words to deserialize in half with less
than double the implementation cost per word. The tree would be structured as
...
The tree would be structured as
...
We could continue this line of thought and consolidate synapses and 
...
\noindent which has the fewest components. However, this would be difficult
a to layout and wire.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Split Ring Deserializer \label{sec:DESERIAL_RING}}
