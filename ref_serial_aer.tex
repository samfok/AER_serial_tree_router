...
\begin{center}
    ...
    PFWD & 53 & 2 & 106 \\ \hline
    MERGE & 117 & 1 & 117 \\ \hline
    \multicolumn{3}{|r|}{total transistors/node} & 223 \\ \hline
    \end{tabular}
\end{center}

223 transistors/node * 4095 nodes / 4096 neurons = \textbf{223.0 transistors/neuron}
...
(223 transistors/node * 4095 nodes - 28672) / 4096 neurons = \textbf{215.9 transistors/neuron}
...
\begin{center}
    ...
    component & transistors/component & components/node & transistors/node \\ \hline
    PFWD & 73 & 4 & 292 \\ \hline
    MERGE & 406 & 1 & 406 \\ \hline
    \multicolumn{3}{|r|}{total transistors/node} & 698 \\ \hline
    \end{tabular}
\end{center}

698 transistors/node * 1365 nodes / 4096 neurons = \textbf{232.6 transistors/neuron}

The leaf node PFWDs only need to communicate the tail bit and their prepend bit and can leave off the other bit.
This saves 4 production rules, or 32 transistors per node. With 1024 leaf nodes, this saves us 32768 transistors.

(698 transistors/node * 4095 nodes - 32768) / 4096 neurons = \textbf{224.6 transistors/neuron}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
