...
We will elimiate the timing assumption and derive CHP and HSE for a greedy but fair arbiter cell here.

\begin{csp}
ARB2\equiv
  *[[#{L1}->C1+;L1+;L1-\star\,C1-]] \pll
  *[[#{L2}->C2+;L2+;L2-\star\,C2-]] \pll
  *[[#{C1}->A1+,R1+;C1+;C1-\star(A1-,R1-)]] \pll
  *[[#{C2}->A2+,R2+;C2+;C2-\star(A2-,R2-)]] \pll
...
or without some of the guard statements:

\begin{csp}
ARB2\equiv
  *[L1\star\,C1+;L1-\star\,C1-] \pll
  *[L2\star\,C2+;L2-\star\,C2-] \pll
  *[C1\star(A1+,R1+);C1-\star(A1-,R1-)] \pll
  *[C2\star(A2+,R2+);C2-\star(A2-,R2-)] \pll
  *[[#{A1}->A1+;A1+\|#{A2}->A2+;A2+]]\pll
  *[[#{R1}|#{R2}];R+;
    [#{R1}->R1+;R1-[]~#{R1}->skip],
    [#{R2}->R2+;R2-[]~#{R2}->skip];
