...
\noindent \\ \textbf{CMOS-implementable PRS version 0}
...
\noindent \\ \textbf{CMOS-implementable PRS version 1}

\noindent An active-low arbiter takes in $\_a0_i$ and $\_a1_i$ to generate $\_a0$ and $\_a1$.
...
The leaf nodes will use version 0, though this is arbitrary, and subsequent levels will alternate versions. Their outputs will be passed through inverters to their children.

\subsection{$N\_ARB\_C$ Accounting}

$N\_ARB\_C$ will be constructed from $N-1$ $N\_ARB\_C\_$ instances. With staticizers, $CTRL$ costs 40 transistors. We require $N$ inverters to interface with the clients. Overall, $N\_ARB\_C$ costs $28(N-1)+2N$ transistors (See Table~\ref{tab:cheap_n_arb_cost}).
...
\begin{table}[ht]
  ...
  \begin{tabular}{|r|c|c|c|c|c|c|c|c|c|}
    ...
    $N$ & 2 & 3 & 4 & 8 & 16 & 32 & 64 & 128 & 256 \\
    \hline
    transistors & 44 & 86 & 128 & 296 & 632 & 1304 & 2648 & 5336 & 10712 \\
    \hline
  \end{tabular}
