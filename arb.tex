...
Including staticizers, $CTRL$ contains 32 transistors.
...
\noindent Including staticizers, $C\_ARB$ requires 22 transistors.

%%%%%%%%%%%%%%%%
\subsubsection{$H\_ARB$ Accounting}

$H\_ARB$ includes 2 $C\_ARB$ circuits and 1 $CTRL$ circuit with 3 additional inverters. Therefore, $H\_ARB$ requires 82 transistors.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{$N\_ARB$ Accounting}

$N\_ARB$ will be constructed from $N-1$ $H\_ARB$ instances. We will also require $N$ inverters to connect with the client's input. Therefore, $N\_ARB$ requires $82(N-1)+2N$ transistors.
